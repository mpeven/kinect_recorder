...
def main(args=None, parser=None):
	...
	##model_file_color = '/home/austin/dev/ThirdParty/caffe/models/bvlc_reference_caffenet/deploy.prototxt'
	pretrained_file_color = 'finetune_color/finetune_objects_color_iter_5000.caffemodel'
	##pretrained_file_color = '/home/austin/dev/ThirdParty/caffe/models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'
	...
	pretrained_file_depth = 'finetune_depth/finetune_objects_depth_iter_5000.caffemodel'
