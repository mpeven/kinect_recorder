...
def main(args=None, parser=None):
	...
	pretrained_file_color = 'finetune_color/finetune_pose_color_iter_5000.caffemodel'
	...
	pretrained_file_depth = 'finetune_depth/finetune_pose_depth_iter_15000.caffemodel'
	...
	color_entries = []
	ifs = open('color_pose_test.txt', 'r')
	while True:
		L = ifs.readline()
		if len(L) == 0:
			break
	...
	# Then depth
	depth_entries = []
	ifs = open('depth_pose_test.txt', 'r')
	while True:
		L = ifs.readline()
		if len(L) == 0:
			break
